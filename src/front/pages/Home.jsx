	...
	return (
		<div>
			<section 
				...
				style={{backgroundImage: "url('src/front/assets/img/red_wavy_with_halftone_background.jpg')", backgroundSize: "cover", minHeight: "500px", height: "auto", borderRadius: "15px"}}

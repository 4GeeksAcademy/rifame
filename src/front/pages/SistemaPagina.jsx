...
const SistemaPagina = () => {
    return (
        <>
            ...
            <section id="pagina-web" className="container mb-5 px-3 px-md-4">
            ...
            <section id="configuraciones" className="row mx-3 mx-md-5 mb-5 g-4">
            ...
            <section id="seguridad" className="container mb-5 px-3 px-md-4">
            ...
            <section id="soporte" className="text-center mb-5 px-3">
